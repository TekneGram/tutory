...
import { resumeWriteExtra } from "../services/resumeWriteExtra.service";
...
export function useResumeWriteExtraMutation(context: WriteExtraProgressContext) {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: resumeWriteExtra,
    onMutate: async (variables: ResumeWriteExtraRequest) => {
