...
- The LearningEntry component:
  - renders *two* cards, one showing the option to enter the English learning flow and the other showing the option to enter the Mathematics learning flow.
- The HeaderBar component:
  - is shown only on the LearningEntry component and the learning front screen.
- The Sidebar component:
  - is shown only on certain components; for now the plan is to show it on the learning main screen and it will contain the list of units that learners can study.
- The learning front screen displays the units that are available for study. When the learner clicks on a Unit card, they navigate to the learning main screen for the selected subject.
- The learning main screen is shown after navigating through the LearningEntry.
