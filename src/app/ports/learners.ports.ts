...
export interface LearnersPort {
  listLearners(request: ListLearnersRequest): Promise<AppResult<ListLearnersResponse>>;
  getLearnerProfile(request: GetLearnerProfileRequest): Promise<AppResult<GetLearnerProfileResponse>>;
  createLearnerProfile(request: CreateLearnerProfileRequest): Promise<AppResult<CreateLearnerProfileResponse>>;
  updateLearnerProfile(request: UpdateLearnerProfileRequest): Promise<AppResult<UpdateLearnerProfileResponse>>;
}
