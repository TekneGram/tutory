...
export interface UnitsPort {
  listLearningUnits(request: ListLearningUnitsRequest): Promise<AppResult<ListLearningUnitsResponse>>;
  getUnitProgress(request: GetUnitProgressRequest): Promise<AppResult<GetUnitProgressResponse>>;
}
